...
const google = async (req, res, next) => {
    ...
    try {
        ...
        if (user) {
            ...
            res.cookie('access_token', token, { httpOnly: true }).status(200).json(rest)//creating a cookie for authorisation and setting its age to 1 hour and http true for not giving access to any other third party app
        } else {
