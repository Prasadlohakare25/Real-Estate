...
function CreateListing() {
    ...
    return (
        <div className='p-3 max-w-4xl mx-auto my-2 bg-slate-200 shadow-xl rounded h-screen'>
            <h1 className='text-center my-6 font-semibold text-3xl'>Create a Listing</h1>
            <form onSubmit={handleSubmit} className='flex flex-col gap-2 sm:flex-row'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg hover:opacity-90 disabled:opacity-80 uppercase'>{loading ? "Creating ..." : "Create Listing"}</button>
